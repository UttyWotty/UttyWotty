...
**Platform / backend engineer building multi-domain intelligence systems.**
...
contract to a shared bus, which a federation gateway exposes to executive AI personas.
The focus is contract-first architecture: one shared schema, strict pure-core /
thin-I/O layering, and engines that stay independent yet speak the same language.
